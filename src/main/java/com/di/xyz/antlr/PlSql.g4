...
// Alris: �졃玲잞옙 占� 茹됬뙘�꽱占� 歷잓눂蟯뜹윃窈ε윃占� 鶯�倻т풚 �젋�겑占� �뀲�눂辱③윹�쓻占�
// pl/sql block
declare_wrapper
...
collection_assoc_expression
    : collection_name ('(' expression ')')* ('.' variable_name)? // 畑�輿쎿돀�윃鸚뽬짔占� �뙲�뫚鸚뽳옙
    ;
...
collection_type_expression
    ...
    | collection_assoc_expression '.' EXISTS '(' expression ')' // 燁㏆옙 畑�輿쎿돀�윃鸚뽬짔占� �뙲�뫚鸚뽬띀 繹�癲숋옙 略ユ퐮 罌욃컟邀�
...
// Alris: 瓦겼섧�겣筌� 癲� standard_function, 占�.占�. 鵝븝옙 繹�翁ワ옙 略ユ퐮 占� SELECT * FROM XMLTABLE()
xml_table_columns
...
// Alris TODO: preprocessor_internal_statement 繹�癲숋옙 略ユ퐮 �뎴罌욆예 罌욃컟�깱占� 占� 旅롳옙 烏녺떫慂�, �슫力� �넍占� 凉� ���뒔蒻� �깱�멨젽占썸돀占�
// 令썲ㄽ�꽱, 凉� 瓦경솮孃ゎ궣�깷 兩쏁윯�겑 �깱�멨젽占썸돀占�:
//BEGIN
...
// �뿁�슫占� �벖占� ���꽔�읅筌� 凉� �쐡�궊�씣占� 獵� 令쏙┥倻뽳옙 旅롨럹, �졃占� PROMPT 占� 瓦겼맽占� 餓꿴낄泳롳옙 凉� 獒붼춳�뫊鸚뽭쉑燁⑼옙 ;
//SQLPLUS_PROMPT: 
//    PROMPT ~[\r\n]* NEWLINE
//    ;
...
package_name
    : (schema_name '.')? id // Alris: ��繇�鶯� 略ユ퐮 �떙獄븝옙, TODO: �떙獄븝옙 ��繇�鶯� 略ユ퐮 凉� 占� �넍鵝� �씘罌욑옙
    ;
...
// Alris: TODO: �뀲癲썲윃占� 獵롥킊玲잌섧占�
// �렏鸚��꽱: - �룵�뤃 ��繇�獒� �쎗沃쇔━逆쀯옙 �렚 甸븃꽊瘟�, �졃占� 繹€굝占� �벖�뼻也꾢땁占� 占� 邀뤹돶罌욄찒 column_alias
...
regular_id
    ...
    | SQLDATA
    | SQLERROR
    | SQL_PERCENT_ROWCOUNT // TODO: ��繇�耶� 力� 鵝� 略ユ퐮 癲룟슫占�?
    | STANDALONE
    | START
    | STARTUP
    | STATEMENT
    ...
    | VAR_
    | COVAR_
    // 凉듣뻗弱딁�� 鶯��솮孃ゆ퐮 渶졿ぃ�돀占� 占� 茹됵쭎�렚, 邀륅옙 獒붼눂�뒽翁곻┝�띀�솣獒앾옙 烏녻띀占�
    | TO_CHAR
    ;
...
SPACES
    // Alris: 燁㏆옙 TokenStreamRewriter 孃ゆ굝占� 令썹퓺鼇�占�, �졃玲잞옙 獵롦죳占� 令썼Þ�젽�뙱占� 瓦계꽔�뤸퐮 �렚�룄占�
    // : [ \t\r\n]+ -> skip 
    : [ \t\r\n]+ -> channel(HIDDEN)
    ;
